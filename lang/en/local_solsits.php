...
$string['assignmentconfigwarning'] = 'Assignment configuration warning digest';
...
$string['assignmentconfigwarning_desc'] = 'This message will form part of an email sent to Module leaders at weekly intervals leading up to the due date, when there are configuration issues with the assignment that may affect students\' ability to submit.
...
$string['configchangeemails'] = 'Configuration change emails';
$string['configchangeemails_desc'] = 'These messages will be sent to Module leaders and extra recipients when assignment settings are changed that could affect student submissions.';
$string['confirmdeletetemplate'] = 'Confirm deletion of "{$a}"';
$string['contextualhelp'] = 'Contextual help';
...
$string['digestemails'] = 'Digest emails';
$string['digestemails_desc'] = 'These messages will be sent to Module leaders and extra recipients when assignment settings are changed that could affect student submissions.';
...
$string['generalsettings'] = 'SITS integration settings';
...
$string['marksuploadssettings_desc'] = 'Settings to manage the marks upload process';
...
$string['modulerangedates'] = 'Unconfigured modules due to start within {$a->range}';
...
$string['send_module_config_errors_message_task'] = 'Send module configuration error message digest';
...
$string['startenddates'] = 'Start and end dates';
