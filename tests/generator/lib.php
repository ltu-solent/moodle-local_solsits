...
class local_solsits_generator extends component_generator_base {
    ...
    public function create_solent_gradescales() {
        ...
        if (!$DB->record_exists('scale', ['name' => 'Solent grademark scale'])) {
            $grademarkscale = $dg->create_scale([
        ...
        if (!$DB->record_exists('scale', ['name' => 'Solent grademark exempt scale'])) {
            $grademarkexemptscale = $dg->create_scale([
        ...
        if (!$DB->record_exists('scale', ['name' => 'Solent numeric scale'])) {
            $numericscale = $dg->create_scale([
            ...
            // Don't create for Quercus as will not be used.
